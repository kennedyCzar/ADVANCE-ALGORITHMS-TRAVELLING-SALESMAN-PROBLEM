...
public interface Constants {
	...
	/* Array of cities */
	public static City[] cities = new City[City.numberOfCities()];
	/* Matrix of distances between cities */
	public static int[][] dis_matrix = new int[City.numberOfCities()][City.numberOfCities()];
	/* Arrays of candidate paths */
	public static String[] candidate_paths = new String[Path.numberOfPossiblePaths()];
	public static City[][] paths = new City[Path.numberOfPossiblePaths()][City.numberOfCities() + 1];
}
