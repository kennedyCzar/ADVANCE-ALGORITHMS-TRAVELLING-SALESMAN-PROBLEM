...
public class BranchAndBound {
	...
	public int[][] matrixReduction (int[][] dis_matrix) {
		...
		int[] min_rows = new int[City.numberOfCities()];
		/* Table of minimum values of columns */
		int[] min_columns = new int[City.numberOfCities()];
		/* Matrix of reduction */
	...
	public void branchAndBound () {
		...
		int[][] m1 = new int[City.numberOfCities()][City.numberOfCities()];
