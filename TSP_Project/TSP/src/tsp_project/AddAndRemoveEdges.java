...
public class AddAndRemoveEdges {
	...
	public static double lowerBound (int[][] matrix) {
		/* Matrix to work on */
		int[][] m = new int[City.numberOfCities()][City.numberOfCities()];
	...
	public static int edgesNumber () {
		return ((City.numberOfCities() - 1) * City.numberOfCities());
	}
	...
	public void addAndRemoveEdges () {
		...
		int[][] matrix = new int[City.numberOfCities()][City.numberOfCities()];
		...
		while (end == 0) {
			...
			while (i < City.numberOfCities()) {
				...
				if (nb_added < 2 && nb_added1 < 2 && nb_added2 < 2 && matrix[starting_vertex][i] != -1 && i != starting_vertex)	{
					if (nb_removed < (edgesNumber() / City.numberOfCities()) - 2 && nb_removed1 < (edgesNumber() / City.numberOfCities()) - 2 && nb_removed2 < (edgesNumber() / City.numberOfCities()) - 2 && i != starting_vertex && Constants.final_edges[starting_vertex][i] != -2) {
						int index = -1;
						int nb=0;
						if (starting_vertex > 0) {
							for (int j=starting_vertex + 1; j < City.numberOfCities(); j++) {
								for (int k=0; k < City.numberOfCities(); k++) {
									if (Constants.final_edges[j][k] == 1) {
										nb++;
									}
						...
						if (index == -1) {
							...
							while (index < City.numberOfCities()) {
								int nb_added3 = 0;
								for (int j=0; j < City.numberOfCities(); j++) {
				...
				if (i != starting_vertex && (lb1 != -1 || lb2 != -1)) {
					if (lb1 <= lb2) {
						...
						else if (lb2 > lowerBound(Constants.dis_matrix) && lb2 != -1 && nb_removed < (edgesNumber() / City.numberOfCities()) - 2 && nb_removed1 < (edgesNumber() / City.numberOfCities()) - 2 && nb_removed2 < (edgesNumber() / City.numberOfCities()) - 2 && i != starting_vertex && Constants.final_edges[starting_vertex][i] != -2) {
							Constants.final_edges[starting_vertex][i] = 2;
							Constants.final_edges[i][starting_vertex] = 2;
						}
					}
					else if (lb2 <= lb1) {
						if (lb2 > lowerBound(Constants.dis_matrix) && lb2 != -1 && nb_removed < (edgesNumber() / City.numberOfCities()) - 2 && nb_removed1 < (edgesNumber() / City.numberOfCities()) - 2 && nb_removed2 < (edgesNumber() / City.numberOfCities()) - 2 && i != starting_vertex && Constants.final_edges[starting_vertex][i] != -2) {
							Constants.final_edges[starting_vertex][i] = 2;
							Constants.final_edges[i][starting_vertex] = 2;
						}
				...
				i++;
				if ((nb_added == 2 && nb_removed != (edgesNumber() / City.numberOfCities()) - 2) || (nb_added != 2 && nb_removed == (edgesNumber() / City.numberOfCities()) - 2)) {
					if (nb_added == 2 && nb_removed != (edgesNumber() / City.numberOfCities()) - 2) {
						for (int j=0; j < City.numberOfCities(); j++) {
					...
					else if (nb_added != 2 && nb_removed == (edgesNumber() / City.numberOfCities()) - 2) {
						for (int j=0; j < City.numberOfCities(); j++) {
				...
				if (starting_vertex == City.numberOfCities() - 1) {
		...
		int[][] edges = new int[2][City.numberOfCities()];
		int index = 0;
		for (int i=0; i < City.numberOfCities(); i++) {
			for (int j=0; j < City.numberOfCities(); j++) {
				if (Constants.final_edges[i][j] == 1) {
